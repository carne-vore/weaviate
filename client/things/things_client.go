...
Deletes a Thing from the system. All Actions pointing to this Thing, where the Thing is the object of the Action, are also deleted.
*/
...
Returns a particular Thing's data.
*/
